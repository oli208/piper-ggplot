...
Then start RStudio in the tab "Packages" you will find a button "install over zip file". Click this button and select the downloaded file and confirm with ok. Now the package will be installed.  
